...
public class RegistrationPage extends javax.swing.JFrame {
    String fName,lName,mName,email,pass,confirmPass;
    public void getUserDetails(){
     ...
     confirmPass=jTextField6.getText();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            int aid=random.nextInt(1000);
            Statement stmt=dbConect.con.createStatement();
            stmt.executeUpdate("INSERT INTO `mgm_users`(`aid`, `user_id`, `user_pass`, `FName`, `LName`, `MName`, `Email`) VALUES ("+aid+",'"+aid+"','"+pass+"','"+fName+"','"+lName+"','"+mName+"','"+email+"')");  
